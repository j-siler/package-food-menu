...
function node.render()
   ...
   local statusline = string.format(
      ...
      d1.y1,
      d1.y2)
   debugfont:write(75, 0, statusline, 12, 0, 255, 255, 1.0)
   ...
   if d2 ~= nil then
	 ...
	 d2.y1,
	 d2.y2)
      debugfont:write(75, 15, statusline, 12, 0, 255, 255, 1.0)
      ...
      local other=6
      if mir then
	 debugfont:write(0, 0, "[1/2]", 12, 255, 255, 255, 1.0)
      elseif l2r then
	 debugfont:write(0, 0, "[1][2]", 12, 255, 255, 255, 1.0)
	 ...
	 debugfont:write(0, 0, "[1]", 12, 255, 255, 255, 1.0)
	 debugfont:write(0, 12, "[2]", 12, 255, 255, 255, 1.0)
      elseif r2l then
	 debugfont:write(0, 0, "[2][1]", 12, 255, 255, 1.0)
	 ...
	 debugfont:write(0, 0, "[2]", 12, 255, 255, 0, 1.0)
	 debugfont:write(0, 12, "[1]", 12, 255, 255, 0, 1.0)
      else
	 debugfont:write(0, 0, "[?]   ", 12, 255, 0, 0, 1.0)
	 debugfont:write(0, 12, "   [?]", 12, 255, 0, 0, 1.0)	 
      end
